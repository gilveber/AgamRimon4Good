...
@WebServlet(name = "DesktopAppLaunched", value = "/DesktopAppLaunched")
public class DesktopAppLaunched extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        customer.setDesktopAppLaunched(customer.getDesktopAppLaunched()+1);

        Tools.DBTools.persistEntity(customer, entityManager);

        response.sendRedirect("http://rimon.smart-sale.co.il/Client/Login.aspx");
